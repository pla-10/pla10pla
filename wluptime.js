...
const csl = client.channels.cache.get('975492889658392687')
...
const liste = ["PLAYING","WATCHING","LISTENING","STREAMING"];
   const listeiki = ["!yardım (DM Önerilir)","WL Uptime Sistemi","İnstagram: a.wollexer"];
    setInterval(()=>{
